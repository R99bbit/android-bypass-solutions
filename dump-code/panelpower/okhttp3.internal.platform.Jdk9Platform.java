...
final class Jdk9Platform extends Platform {
    ...
    /* JADX WARNING: type inference failed for: r7v0, types: [java.util.List<okhttp3.Protocol>, java.util.List] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public void configureTlsExtensions(SSLSocket sSLSocket, String str, List<Protocol> r7) {
        try {
            SSLParameters sSLParameters = sSLSocket.getSSLParameters();
            List<String> alpnProtocolNames = alpnProtocolNames(r7);
