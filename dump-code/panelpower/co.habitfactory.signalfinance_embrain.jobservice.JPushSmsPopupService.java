...
public class JPushSmsPopupService extends SafeJobIntentService implements SignalLibConsts {
    static final int JOB_ID = 1022;
    /* access modifiers changed from: private */
    public final String TAG = JPushSmsPopupService.class.getSimpleName();
    private Context mContext;
    private long mLongRowId;
    private SignalLibPrefs mPrefs;
    private PushDataSet mPushSmsDs;
    ...
    private void savePushSmsData(String str, String str2, String str3, String str4, String str5, String str6) throws Exception {
        String str7;
        DatabaseHelperPushSms instance = DatabaseHelperPushSms.getInstance(getApplicationContext());
        try {
            instance.onCreateWithTable(instance.getDB(), DatabaseHelperPushSms.TABLE_NAME);
        } catch (SQLException e) {
            e.printStackTrace();
        }
        this.mPushSmsDs = null;
        try {
        ...
        try {
            if (!chkGpsService()) {
                ...
                this.mPushSmsDs = pushDataSet2;
            }
        } catch (Exception e3) {
            e3.printStackTrace();
        }
        try {
            this.mLongRowId = instance.addRow(this.mPushSmsDs);
        } catch (Exception e4) {
            e4.printStackTrace();
        }
        try {
            ...
            String str10 = str9;
            String str11 = str10;
            IptSavePushData iptSavePushData = new IptSavePushData(userId, this.mPushSmsDs.getUserSimNumber(), this.mPushSmsDs.getPackageNm(), this.mPushSmsDs.getNotiTitle(), this.mPushSmsDs.getNotiText(), this.mPushSmsDs.getNotiSubText(), this.mPushSmsDs.getNotificationBigText(), this.mPushSmsDs.getTimestampMillis(), str9, str10, str11, str11, SignalLibConsts.g_DataChannel);
    ...
    private void requestRetrofit(IptSavePushData iptSavePushData) throws Exception {
        APIHelper.enqueueWithRetry(RestfulAdapter.getInstance(this).requestSavePushSmsData(iptSavePushData), 1, new Callback<OptSaveSmsData>() {
            public void onResponse(Call<OptSaveSmsData> call, Response<OptSaveSmsData> response) {
                ...
                if (code == 200) {
                    ...
                    if (optSaveSmsData != null) {
                        String access$000 = JPushSmsPopupService.this.TAG;
                        StringBuilder sb = new StringBuilder();
                        sb.append("response");
                        sb.append(String.valueOf(code));
                        SignalUtil.PRINT_LOG(access$000, sb.toString());
                        try {
                            JPushSmsPopupService.this.parseResult(optSaveSmsData);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    } else {
                        SignalUtil.PRINT_LOG(JPushSmsPopupService.this.TAG, "response : result null");
                        try {
                            JPushSmsPopupService.this.updateSendToServerDatabase();
                        } catch (Exception e2) {
                            e2.printStackTrace();
                        }
                        JPushSmsPopupService.this.stopSelf();
                    }
                } else {
                    String access$0002 = JPushSmsPopupService.this.TAG;
    ...
    public void parseResult(OptSaveSmsData optSaveSmsData) throws Exception {
        ...
        if (resultcode.equals("00")) {
            ...
            if (NULL_TO_STRING2.length() > 0 && "T".equals(NULL_TO_STRING2.toUpperCase())) {
                try {
                    Intent intent = new Intent(getApplicationContext(), JFusedSmsLocationService.class);
                    ...
                    JFusedSmsLocationService.enqueueWork(getApplicationContext(), intent);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public void updateSendToServerDatabase() throws Exception {
        ...
        if (!(this.mPushSmsDs.getPackageNm() == null && this.mPushSmsDs.getNotiText() == null && this.mPushSmsDs.getNotiText().length() <= 0) && !instance.checkBodyRowExist(this.mPushSmsDs.getNotiTitle(), this.mPushSmsDs.getNotiText(), this.mPushSmsDs.getPackageNm()).booleanValue()) {
            PushDataSet pushDataSet = new PushDataSet("", "", "", this.mPushSmsDs.getPackageNm(), this.mPushSmsDs.getNotiTitle(), this.mPushSmsDs.getNotiText(), this.mPushSmsDs.getNotiSubText(), this.mPushSmsDs.getNotificationBigText(), this.mPushSmsDs.getTimestampMillis(), "", "", "", "", "", "", "", "N", "N", SignalLibConsts.g_DataChannel);
            try {
