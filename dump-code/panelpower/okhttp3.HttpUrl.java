...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        private Builder addPathSegments(String str, boolean z) {
            int i = 0;
            do {
                int delimiterOffset = Util.delimiterOffset(str, i, str.length(), (String) "/\\");
        ...
        public ParseResult parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl2 == null || !httpUrl2.scheme.equals(this.scheme)) {
                ...
                boolean z2 = false;
                while (true) {
                    delimiterOffset = Util.delimiterOffset(str2, i3, skipTrailingAsciiWhitespace, (String) "@/\\?#");
            ...
            int delimiterOffset3 = Util.delimiterOffset(str2, i, skipTrailingAsciiWhitespace, (String) "?#");
    ...
    public String encodedUsername() {
        ...
        String str = this.url;
        return this.url.substring(length, Util.delimiterOffset(str, length, str.length(), (String) ":@"));
    }
    ...
    public String encodedPath() {
        ...
        String str = this.url;
        return this.url.substring(indexOf, Util.delimiterOffset(str, indexOf, str.length(), (String) "?#"));
    }
    ...
    public List<String> encodedPathSegments() {
        int indexOf = this.url.indexOf(47, this.scheme.length() + 3);
        String str = this.url;
        int delimiterOffset = Util.delimiterOffset(str, indexOf, str.length(), (String) "?#");
