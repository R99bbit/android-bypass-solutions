...
public class DatabaseHelperPush extends SQLiteOpenHelper implements SignalLibConsts {
    ...
    public static final String TABLE_NAME = "tablepush";
    private static DatabaseHelperPush sInstance;
    ...
    public static synchronized DatabaseHelperPush getInstance(Context context) {
        DatabaseHelperPush databaseHelperPush;
        synchronized (DatabaseHelperPush.class) {
            try {
                if (sInstance == null) {
                    sInstance = new DatabaseHelperPush(context.getApplicationContext());
                }
                databaseHelperPush = sInstance;
            }
        }
        return databaseHelperPush;
    }

    public DatabaseHelperPush(Context context) {
