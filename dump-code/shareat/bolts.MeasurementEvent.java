...
public class MeasurementEvent {
    ...
    private void sendBroadcast() {
        ...
        try {
            ...
            Method methodGetInstance = cls.getMethod("getInstance", new Class[]{Context.class});
            Method methodSendBroadcast = cls.getMethod("sendBroadcast", new Class[]{Intent.class});
