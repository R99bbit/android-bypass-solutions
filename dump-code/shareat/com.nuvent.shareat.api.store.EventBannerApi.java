...
public class EventBannerApi extends Request {
    public EventBannerApi(Context context) {
        super(context);
        this.serviceUrl = ApiUrl.EVENT_BANNER_URL;
        this.method = HttpRequest.METHOD_GET;
    }

    /* access modifiers changed from: protected */
    public Object parseContent(Header[] headers, String responseText) throws Exception {
        return (EventBannerResultModel) new Gson().fromJson((JsonElement) new JsonParser().parse(responseText).getAsJsonObject(), EventBannerResultModel.class);
    }
