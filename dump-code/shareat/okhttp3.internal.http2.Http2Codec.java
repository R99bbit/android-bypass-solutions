...
public final class Http2Codec implements HttpCodec {
    ...
    public Http2Codec(OkHttpClient client, Chain chain2, StreamAllocation streamAllocation2, Http2Connection connection2) {
        Protocol protocol2;
        this.chain = chain2;
    ...
    public static Builder readHttp2HeadersList(List<Header> headerBlock, Protocol protocol2) throws IOException {
