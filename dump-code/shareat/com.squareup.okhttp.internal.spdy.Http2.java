        ...
        static String formatFlags(byte type, byte flags) {
            ...
            switch (type) {
                ...
                default:
                    ...
                    if (type != 5 || (flags & 4) == 0) {
                        return (type != 0 || (flags & HttpConstants.SP) == 0) ? result : result.replace("PRIORITY", "COMPRESSED");
                    }
    ...
    static final class Writer implements FrameWriter {
        ...
        public synchronized void rstStream(int streamId, ErrorCode errorCode) throws IOException {
            if (this.closed) {
                ...
                frameHeader(streamId, 4, Http2.TYPE_RST_STREAM, 0);
        ...
        public synchronized void goAway(int lastGoodStreamId, ErrorCode errorCode, byte[] debugData) throws IOException {
            if (this.closed) {
                ...
                frameHeader(0, debugData.length + 8, Http2.TYPE_GOAWAY, 0);
