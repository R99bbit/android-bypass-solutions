...
public final class Cache {
    ...
    public Cache(File directory, long maxSize) {
        this.cache = DiskLruCache.create(FileSystem.SYSTEM, directory, VERSION, 2, maxSize);
    }
    ...
    public CacheRequest put(Response response) throws IOException {
        ...
        } else if (!requestMethod.equals(HttpRequest.METHOD_GET) || OkHeaders.hasVaryAll(response)) {
            return null;
        } else {
        ...
        return new Iterator<String>() {
            ...
            public boolean hasNext() {
                ...
                while (this.delegate.hasNext()) {
                    Snapshot snapshot = this.delegate.next();
                    try {
