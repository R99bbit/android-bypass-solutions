...
class AndroidPlatform extends Platform {
    ...
    static final class CloseGuard {
        ...
        static CloseGuard get() {
            ...
            try {
                ...
                getMethod2 = cls.getMethod("get", new Class[0]);
                openMethod2 = cls.getMethod("open", new Class[]{String.class});
                warnIfOpenMethod2 = cls.getMethod("warnIfOpen", new Class[0]);
            } catch (Exception e) {
                getMethod2 = null;
                openMethod2 = null;
    ...
    public boolean isCleartextTrafficPermitted(String hostname) {
        try {
            ...
            return api24IsCleartextTrafficPermitted(hostname, cls, cls.getMethod("getInstance", new Class[0]).invoke(null, new Object[0]));
    ...
    public CertificateChainCleaner buildCertificateChainCleaner(X509TrustManager trustManager) {
        try {
            ...
            return new AndroidCertificateChainCleaner(cls.getConstructor(new Class[]{X509TrustManager.class}).newInstance(new Object[]{trustManager}), cls.getMethod("checkServerTrusted", new Class[]{X509Certificate[].class, String.class, String.class}));
        } catch (Exception e) {
    ...
    public static Platform buildIfSupported() {
        ...
        try {
            ...
            return new AndroidPlatform(cls, setUseSessionTickets2, setHostname2, getAlpnSelectedProtocol2, setAlpnProtocols2);
