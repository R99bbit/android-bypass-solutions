        ...
        for (int i = 0; i < size; i++) {
            ...
            while (pos < value.length()) {
                ...
                if (pos2 == value.length() || value.charAt(pos2) == ',' || value.charAt(pos2) == ';') {
                    ...
                    int pos3 = HeaderParser.skipWhitespace(value, pos2 + 1);
                ...
                if ("no-cache".equalsIgnoreCase(directive)) {
                    ...
                    maxAgeSeconds2 = HeaderParser.parseSeconds(parameter, -1);
                } else if (Values.S_MAXAGE.equalsIgnoreCase(directive)) {
                    sMaxAgeSeconds2 = HeaderParser.parseSeconds(parameter, -1);
                    ...
                    maxStaleSeconds2 = HeaderParser.parseSeconds(parameter, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
                } else if ("min-fresh".equalsIgnoreCase(directive)) {
                    minFreshSeconds2 = HeaderParser.parseSeconds(parameter, -1);
