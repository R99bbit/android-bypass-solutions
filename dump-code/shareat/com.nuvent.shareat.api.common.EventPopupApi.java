...
public class EventPopupApi extends Request {
    public EventPopupApi(Context context) {
        super(context);
        this.serviceUrl = ApiUrl.EVENT_POPUP;
        this.method = HttpRequest.METHOD_GET;
    }

    /* access modifiers changed from: protected */
    public Object parseContent(Header[] headers, String responseText) throws Exception {
        return (BoardResultModel) new Gson().fromJson((JsonElement) new JsonParser().parse(responseText).getAsJsonObject(), BoardResultModel.class);
    }
