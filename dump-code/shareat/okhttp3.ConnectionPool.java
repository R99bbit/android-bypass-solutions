    ...
    private int pruneAndGetAllocationCount(RealConnection connection, long now) {
        ...
        while (i < references.size()) {
            ...
            if (reference.get() != null) {
                ...
                Platform.get().logCloseableLeak("A connection to " + connection.route().address().url() + " was leaked. Did you forget to close a response body?", ((StreamAllocationReference) reference).callStackTrace);
                references.remove(i);
                connection.noNewStreams = true;
