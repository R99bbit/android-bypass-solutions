...
final class SpdyCodecUtil {
    ...
    static int getUnsignedInt(ChannelBuffer buf, int offset) {
        return ((buf.getByte(offset) & Byte.MAX_VALUE) << 24) | ((buf.getByte(offset + 1) & 255) << 16) | ((buf.getByte(offset + 2) & 255) << 8) | (buf.getByte(offset + 3) & 255);
    }
