...
public class JsonReader implements Closeable {
    ...
    private IOException syntaxError(String message) throws IOException {
        throw new MalformedJsonException(new StringBuilder(String.valueOf(message)).append(" at line ").append(getLineNumber()).append(" column ").append(getColumnNumber()).toString());
    }
