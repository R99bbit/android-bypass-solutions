...
public class StoreResultBlogModel extends BaseResultModel {
    public String chk_review;
    public ArrayList<StoreBlogModel> result_list = new ArrayList<>();
    public String total_cnt;

    public ArrayList<StoreBlogModel> getResult_list() {
