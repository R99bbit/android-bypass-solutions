...
public class ConditionChecker {
            ...
            if (scheme.equals("device")) {
                ...
                if (key.equals("width")) {
                    ...
                    if (VERSION.SDK_INT < 13) {
                        return Integer.valueOf(display.getWidth());
                    }
                    Point size = new Point();
                    display.getSize(size);
                    return Integer.valueOf(size.x);
                } else if (key.equals("height")) {
                    Display display2 = ((WindowManager) context.getSystemService("window")).getDefaultDisplay();
                    if (VERSION.SDK_INT < 13) {
                        return Integer.valueOf(display2.getHeight());
                    }
                    Point size2 = new Point();
                    display2.getSize(size2);
                    return Integer.valueOf(size2.y);
                } else if (key.equals("is_portrait")) {
                ...
                try {
                    ...
                    return new StringBuilder(String.valueOf((((new Date().getTime() - Long.parseLong(dao.getImpressionData(context, scheduleType, targetStorageKey, key))) / 1000) / 60) + 1)).toString();
                } catch (Exception e) {
                    return Integer.valueOf(0);
                }
    ...
    public static boolean checkInstalled(Context context, String scheme) {
        try {
            context.getPackageManager().getApplicationInfo(scheme, 0);
            return true;
