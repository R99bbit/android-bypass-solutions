...
public class WebSocketClientHandshaker08 extends WebSocketClientHandshaker {
    ...
    public ChannelFuture handshake(Channel channel) throws Exception {
        ...
        request.headers().add((String) Names.SEC_WEBSOCKET_VERSION, (Object) "8");
        ...
        AnonymousClass1 r0 = new ChannelFutureListener() {
            public void operationComplete(ChannelFuture future) {
                future.getChannel().getPipeline().replace(HttpRequestEncoder.class, (String) "ws-encoder", (ChannelHandler) new WebSocket08FrameEncoder(true));
                if (future.isSuccess()) {
