...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public Builder scheme(String scheme2) {
            ...
            if (scheme2.equalsIgnoreCase("http")) {
                this.scheme = "http";
            } else if (scheme2.equalsIgnoreCase(CommonProtocol.URL_SCHEME)) {
                this.scheme = CommonProtocol.URL_SCHEME;
            } else {
        ...
        public Builder username(String username) {
            ...
            this.encodedUsername = HttpUrl.canonicalize(username, HttpUrl.USERNAME_ENCODE_SET, false, false);
            return this;
        }
        ...
        public Builder encodedUsername(String encodedUsername2) {
            ...
            this.encodedUsername = HttpUrl.canonicalize(encodedUsername2, HttpUrl.USERNAME_ENCODE_SET, true, false);
            return this;
        }
        ...
        public Builder password(String password) {
            ...
            this.encodedPassword = HttpUrl.canonicalize(password, HttpUrl.PASSWORD_ENCODE_SET, false, false);
            return this;
        }
        ...
        public Builder encodedPassword(String encodedPassword2) {
            ...
            this.encodedPassword = HttpUrl.canonicalize(encodedPassword2, HttpUrl.PASSWORD_ENCODE_SET, true, false);
            return this;
        }
        ...
        public Builder removeAllQueryParameters(String name) {
            ...
            if (this.encodedQueryNamesAndValues != null) {
                removeAllCanonicalQueryParameters(HttpUrl.canonicalize(name, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, true));
            }
            return this;
        }
        ...
        public Builder fragment(String fragment) {
            ...
            this.encodedFragment = HttpUrl.canonicalize(fragment, "", false, false);
            return this;
        }
        ...
        public Builder encodedFragment(String encodedFragment2) {
            ...
            this.encodedFragment = HttpUrl.canonicalize(encodedFragment2, "", true, false);
            return this;
        }
        ...
        /* access modifiers changed from: 0000 */
        public HttpUrl parse(HttpUrl base, String input) {
                    ...
                    switch (componentDelimiterOffset != limit ? input.charAt(componentDelimiterOffset) : -1) {
                        ...
                        case 64:
                            if (!hasPassword) {
                                ...
                                String canonicalUsername = HttpUrl.canonicalize(input, pos2, passwordColonOffset, HttpUrl.USERNAME_ENCODE_SET, true, false);
                                if (hasUsername) {
                                ...
                                if (passwordColonOffset != componentDelimiterOffset) {
                                    hasPassword = true;
                                    this.encodedPassword = HttpUrl.canonicalize(input, passwordColonOffset + 1, componentDelimiterOffset, HttpUrl.PASSWORD_ENCODE_SET, true, false);
                                }
                                hasUsername = true;
                            } else {
                                this.encodedPassword += "%40" + HttpUrl.canonicalize(input, pos2, componentDelimiterOffset, HttpUrl.PASSWORD_ENCODE_SET, true, false);
                            }
            ...
            if (pos3 < limit && input.charAt(pos3) == '#') {
                this.encodedFragment = HttpUrl.canonicalize(input, pos3 + 1, limit, "", true, false);
            }
            return build();
        }
        ...
        private static String canonicalizeHost(String input, int pos, int limit) {
            ...
            if (!percentDecoded.startsWith("[") || !percentDecoded.endsWith("]")) {
                ...
                if (HttpUrl.delimiterOffset(idnDecoded, 0, length, "\u0000\t\n\r #%/:?@[\\]") == length) {
                    return idnDecoded;
                }
                return null;
            }
        ...
        private static int parsePort(String input, int pos, int limit) {
            try {
                int i = Integer.parseInt(HttpUrl.canonicalize(input, pos, limit, "", false, false));
                if (i <= 0 || i > 65535) {
                    return -1;
                }
                return i;
    ...
    public boolean isHttps() {
        return this.scheme.equals(CommonProtocol.URL_SCHEME);
    }
    ...
    public static int defaultPort(String scheme2) {
        ...
        if (scheme2.equals(CommonProtocol.URL_SCHEME)) {
            return 443;
        }
        return -1;
    }
    ...
    public static HttpUrl parse(String url2) {
        return new Builder().parse(null, url2);
    }
