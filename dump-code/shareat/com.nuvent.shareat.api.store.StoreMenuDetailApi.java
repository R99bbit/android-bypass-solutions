...
public class StoreMenuDetailApi extends Request {
    public StoreMenuDetailApi(Context context) {
        super(context);
        this.serviceUrl = ApiUrl.MENU_DETAIL_LIST_URL;
        this.method = HttpRequest.METHOD_GET;
    }

    /* access modifiers changed from: protected */
    public Object parseContent(Header[] headers, String responseText) throws Exception {
        return (StoreMenuResultModel) new Gson().fromJson((JsonElement) new JsonParser().parse(responseText).getAsJsonObject(), StoreMenuResultModel.class);
    }
