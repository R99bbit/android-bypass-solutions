...
final class Hpack {
    ...
    static final Header[] STATIC_HEADER_TABLE = {new Header(Header.TARGET_AUTHORITY, (String) ""), new Header(Header.TARGET_METHOD, (String) "GET"), new Header(Header.TARGET_METHOD, (String) "POST"), new Header(Header.TARGET_PATH, (String) "/"), new Header(Header.TARGET_PATH, (String) "/index.html"), new Header(Header.TARGET_SCHEME, (String) "http"), new Header(Header.TARGET_SCHEME, (String) "https"), new Header(Header.RESPONSE_STATUS, (String) "200"), new Header(Header.RESPONSE_STATUS, (String) "204"), new Header(Header.RESPONSE_STATUS, (String) "206"), new Header(Header.RESPONSE_STATUS, (String) "304"), new Header(Header.RESPONSE_STATUS, (String) "400"), new Header(Header.RESPONSE_STATUS, (String) "404"), new Header(Header.RESPONSE_STATUS, (String) "500"), new Header((String) "accept-charset", (String) ""), new Header((String) "accept-encoding", (String) "gzip, deflate"), new Header((String) "accept-language", (String) ""), new Header((String) "accept-ranges", (String) ""), new Header((String) "accept", (String) ""), new Header((String) "access-control-allow-origin", (String) ""), new Header((String) "age", (String) ""), new Header((String) "allow", (String) ""), new Header((String) "authorization", (String) ""), new Header((String) "cache-control", (String) ""), new Header((String) "content-disposition", (String) ""), new Header((String) "content-encoding", (String) ""), new Header((String) "content-language", (String) ""), new Header((String) "content-length", (String) ""), new Header((String) "content-location", (String) ""), new Header((String) "content-range", (String) ""), new Header((String) "content-type", (String) ""), new Header((String) "cookie", (String) ""), new Header((String) "date", (String) ""), new Header((String) "etag", (String) ""), new Header((String) "expect", (String) ""), new Header((String) "expires", (String) ""), new Header((String) "from", (String) ""), new Header((String) "host", (String) ""), new Header((String) "if-match", (String) ""), new Header((String) "if-modified-since", (String) ""), new Header((String) "if-none-match", (String) ""), new Header((String) "if-range", (String) ""), new Header((String) "if-unmodified-since", (String) ""), new Header((String) "last-modified", (String) ""), new Header((String) MessageTemplateProtocol.LINK, (String) ""), new Header((String) "location", (String) ""), new Header((String) "max-forwards", (String) ""), new Header((String) "proxy-authenticate", (String) ""), new Header((String) "proxy-authorization", (String) ""), new Header((String) "range", (String) ""), new Header((String) "referer", (String) ""), new Header((String) "refresh", (String) ""), new Header((String) "retry-after", (String) ""), new Header((String) "server", (String) ""), new Header((String) "set-cookie", (String) ""), new Header((String) "strict-transport-security", (String) ""), new Header((String) "transfer-encoding", (String) ""), new Header((String) "user-agent", (String) ""), new Header((String) "vary", (String) ""), new Header((String) "via", (String) ""), new Header((String) "www-authenticate", (String) "")};
